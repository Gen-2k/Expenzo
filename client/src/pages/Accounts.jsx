  ...
  const ACCOUNTS = [
    {
      ...
      balance: 24500,
      number: '**** 8892',
      theme: 'bg-gradient-to-br from-blue-600 to-blue-800',
      icon: Wallet,
    },
    {
      id: 2,
      ...
      balance: -12400,
      number: '**** 4545',
      theme: 'bg-gradient-to-br from-gray-800 to-gray-900',
      icon: CreditCard,
    },
    {
      id: 3,
      ...
      balance: 850,
      number: '98765xxxxx',
      theme: 'bg-gradient-to-br from-sky-400 to-blue-500',
      icon: Smartphone,
    },
    {
      id: 4,
  ...
  return (
    <Layout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500">
              Manage all your payment sources in one place.
            </p>
          </div>
        ...
        {/* --- SECTION 2: ACCOUNTS GRID --- */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Account Cards */}
          {ACCOUNTS.map((acc) => (
            <div
              key={acc.id}
              className={`relative overflow-hidden rounded-3xl p-6 text-white shadow-xl transition-all ${acc.theme}`}
            >
              {/* Background Pattern */}
              ...
              <div className="relative z-10 flex flex-col h-full justify-between min-h-[180px]">
                ...
                {/* Balance Info */}
                <div>
                  <p className="text-white/80 text-sm font-medium tracking-wide opacity-90">
                    {acc.name}
                  </p>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 hover:bg-white border border-gray-100/50 hover:border-gray-200 transition-all cursor-pointer group"
              >
            ...
            <div className="text-center pt-2">
              <button className="text-sm font-semibold text-primary-600 hover:text-primary-700 hover:underline">
                View All Activity
              </button>
            </div>
          </div>
